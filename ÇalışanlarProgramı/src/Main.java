...
public class Main {
	public static void main(String[] args) {
		 ...
		 * 
		 * Calisan Sınıfından Türeyen Yazilimci adında Bir Alt Sınıf Calisan Sınıfından
		 * Türeyen Yonetici adında Bir Alt Sınıf
		 * 
		 */
		...
		while (true) {
			...
			if (islem.equals("q")) {
				...
				Yazilimci yazilimci = new Yazilimci("Cem", "Uğurlu", 567, "Python,C,Java");
